...
const COMPUTED_FORMS = {
  ...
  COCIENTE_DE_BIENESTAR_PERCIBIDO: 'COCIENTE_DE_BIENESTAR_PERCIBIDO', // Reporte Maika
  COCIENTE_DE_BIENESTAR_PONDERADO_CON_ADN: 'COCIENTE_DE_BIENESTAR_PONDERADO_CON_ADN' // Reporte Total con ADN
};
